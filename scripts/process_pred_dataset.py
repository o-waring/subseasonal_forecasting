...
def get_2wk_lat_lon_data(df, var, events_per_day=4):
    ...
    latlon_list = []
    for region in target_points['region'].unique():
...
if __name__ == "__main__":
    ...
    target_points = pd.read_csv('../target_points.csv')
    ...
    file_path = '../../weather_forecasting_app/data/prediction_inputs/'
    ...
    dataset_dict = {
        'hgt':{'fp_prfx':'hgt','lat_min':lat_min, 'lat_max':lat_max, 'lon_min':lon_min, 'lon_max':lon_max, 'level':10},
        'pres':{'fp_prfx':'pres.sfc.gauss','lat_min':lat_min, 'lat_max':lat_max, 'lon_min':lon_min, 'lon_max':lon_max, 'level':None},
        'pevpr':{'fp_prfx':'pevpr.sfc.gauss','lat_min':lat_min, 'lat_max':lat_max, 'lon_min':lon_min, 'lon_max':lon_max, 'level':None},
        'slp':{'fp_prfx':'slp','lat_min':lat_min, 'lat_max':lat_max, 'lon_min':lon_min, 'lon_max':lon_max, 'level':None},
        'rhum':{'fp_prfx':'rhum.sig995','lat_min':lat_min, 'lat_max':lat_max, 'lon_min':lon_min, 'lon_max':lon_max, 'level':None},
        'pr_wtr':{'fp_prfx':'pr_wtr.eatm','lat_min':lat_min, 'lat_max':lat_max, 'lon_min':lon_min, 'lon_max':lon_max, 'level':None}
    }
    ...
    np.save('../../weather_forecasting_app/data/prediction_inputs/processed_features', np.array(df))