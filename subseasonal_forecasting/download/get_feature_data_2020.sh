...
# cd data/prediction/ && { curl -O ftp://ftp.cdc.noaa.gov/Projects/Datasets/noaa.oisst.v2.highres/icec.day.mean.2020.nc -o icec.day.mean.2020.nc ; cd -; }
# Perhaps - ftp://ftp.cdc.noaa.gov/Datasets/ncep.reanalysis/surface_gauss/

#
# # sst 2020 #WRONG - need PCA data
# cd data/prediction/ && { curl -O ftp://ftp.cdc.noaa.gov/Projects/Datasets/noaa.oisst.v2.highres/sst.day.mean.2020.nc -o sst.day.mean.2020.nc ; cd -; }
...
# MEI
#cd data/prediction/ && { curl -O https://psl.noaa.gov/enso/mei/data/meiv2.data -o meiv2.data ; cd -; }
