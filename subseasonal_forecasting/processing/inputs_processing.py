...
def process_series(data_path, repo_path):
...
class PreprocessTemporalSpatialData:
    ...
    def __init__(self, data: np.array, locations: np.array, col_names: list, num_regions: int, num_features: int,
                 max_sg: int = 5):
        self.data = data
    ...
    def get_global_region_tensor(self, save=False):
        ...
        if save:
            ...
            np.save(repo_path + '/data/processed/spatial_temporal/global_region_tensor_scaled_sg' + str(self.max_sg),
